...
<div class="row">
                ...
                <form role="form" action="house?action=houseEdit" data-toggle="validator modal" method="post">
                    <div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="num" value ="${house.num }"required>
                    ...
                    <div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="dep" value ="${house.dep }" required>
							<span class="help-block with-errors"></span>
						</div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="area" value ="${house.area }" required>
							<span class="help-block with-errors"></span>
						</div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="unit"  value ="${house.unit }" required>
							<span class="help-block with-errors"></span>
						</div>
                    </div>
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="number" class="form-control" name="floor"  value ="${house.floor }" required>
							<span class="help-block with-errors"></span>
						</div>
                    </div>
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<option value="${house.direction }">${house.direction }</option>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="ownerid" value ="${house.ownerid }">
						</div>
                    </div>
					<div class="form-group">
						<div class="input-group col-md-4">
							<label class="control-label" >备注</label>
							<input type="text" class="form-control" name="memo" value ="${house.memo }">
						</div>
					</div>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; 2010 - 2021</p>
